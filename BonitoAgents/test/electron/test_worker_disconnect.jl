...
mkpath(proj_dir)
p = BonitoAgents.ProjectInfo("p-locked", "LockedProj", "transient-w",
        proj_dir, "/tmp/worker/LockedProj", BonitoAgents.now(BonitoAgents.UTC))
p.locked_by = "transient-w"
p.locked_at = BonitoAgents.now(BonitoAgents.UTC)
