...
let s = BonitoTeam.ServerState(;
    ...
    s.projects["pa"] = BonitoTeam.ProjectInfo(
        "pa", "ProjAlpha", "alpha",
    ...
    s.projects["pb"] = BonitoTeam.ProjectInfo(
        "pb", "ProjBeta", "beta",
    ...
    s.projects["pc"] = BonitoTeam.ProjectInfo(
    ...
    BonitoTeam.save_workers!(s)
    BonitoTeam.save_projects!(s)
end
...
TH.section("Projects round-tripped") do
    ...
    if haskey(s2.projects, "pa")
        ...
        record("pa worker_name",   @TH.test_eq pa.worker_name   "alpha")
...
TH.section("Empty state_dir is handled gracefully") do
    empty_dir = mktempdir()
    s_empty = BonitoTeam.ServerState(;
        state_dir     = empty_dir,
        working_dir   = mktempdir(),
        worker_secret = "x")
