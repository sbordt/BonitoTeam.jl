...
#
# Real stack (no mocks):
#   - BonitoTeam.serve()                 (production URL)
...
try
    ...
    p_alpha = BonitoTeam.ProjectInfo("alpha", "Alpha", "resume-test-worker-id",
    ...
    p_beta = BonitoTeam.ProjectInfo("beta", "Beta", "resume-test-worker-id",
