...
#      same env vars production uses) dials a live BonitoTeam server;
...
@testset "MCP control channel + AGENTS.md" begin
    ...
    @testset "ctrl dial-back + interrupt round-trip" begin
        ...
        try
            ...
            withenv("BONITOTEAM_SERVER_URL" => url,
                    "BONITOTEAM_SECRET"     => "ctrl-secret",
                    "BONITOTEAM_PROJECT_ID" => "ctrl-proj") do
