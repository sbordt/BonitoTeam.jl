...
# the LLM deciding to call bt_show_app and the agent→ACP→ToolMsg relay (BonitoTeam's
# existing, tested machinery) — and the browser pixels. No Electron.
using Test
import BonitoTeam, BonitoMCP
const BT = BonitoTeam; const Malt = BonitoTeam.Malt
